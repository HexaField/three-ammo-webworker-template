...
var Ammo = (function () {
  ...
  return function (Ammo) {
    ...
    g.asm = function () {
      ...
      if (g.instantiateWasm)
        try {
          ...
          return (
            qa('Module.instantiateWasm callback failed with error: ' + f), !1
          );
        }
      (function () {
        if (
    ...
    function lb(a, c, d, e) {
      try {
        for (var f = 0, n = 0; n < d; n++) {
          for (
            var r = h[(c + 8 * n) >> 2], N = h[(c + (8 * n + 4)) >> 2], ba = 0;
            ba < N;
            ba++
          ) {
            var Ia = Aa[r + ba],
    ...
    function zb(a, c, d, e) {
      function f(a, c, d) {
        for (a = 'number' === typeof a ? a.toString() : a || ''; a.length < c; )
          a = d[0] + a;
        return a;
      }
      function n(a, c) {
        ...
        '%W': function (a) {
          var c = new Date(a.Cs, 0, 1),
            d =
              1 === c.getDay()
                ? c
                : yb(c, 0 === c.getDay() ? 1 : 7 - c.getDay() + 1);
          a = new Date(a.Cs + 1900, a.Ks, a.Us);
          return 0 > r(d, a)
            ? n(
                Math.ceil(
      ...
      for (va in Ia)
        0 <= d.indexOf(va) && (d = d.replace(new RegExp(va, 'g'), Ia[va](e)));
      va = Ab(d, !1);
        ...
        i: function (a) {
          ...
          for (var c = Math.max(nb(), 16777216); c < a; )
            c =
              536870912 >= c
                ? Da(2 * c)
                : Math.min(Da((3 * c + 2147483648) / 4), 2147418112);
          a: {
            try {
    ...
    var Bb = (g.__ZSt18uncaught_exceptionv = function () {
      ...
      nc = (g._emscripten_bind_ClosestConvexResultCallback_set_m_collisionFilterGroup_1 = function () {
      ...
      Rk = (g._emscripten_bind_btDispatcherInfo_get_m_useConvexConservativeDistanceUtil_0 = function () {
        return g.asm.Fi.apply(null, arguments);
      }),
      ...
      sm = (g._emscripten_bind_btGeneric6DofSpringConstraint_setBreakingImpulseThreshold_1 = function () {
      ...
      co = (g._emscripten_bind_btKinematicCharacterController_btKinematicCharacterController_4 = function () {
        return g.asm.Ml.apply(null, arguments);
      }),
      ...
      Uq = (g._emscripten_bind_btRigidBodyConstructionInfo_get_m_additionalAngularDampingFactor_0 = function () {
        return g.asm.Bo.apply(null, arguments);
      }),
      ...
      Yq = (g._emscripten_bind_btRigidBodyConstructionInfo_get_m_additionalLinearDampingThresholdSqr_0 = function () {
        return g.asm.Fo.apply(null, arguments);
      }),
      ...
      jr = (g._emscripten_bind_btRigidBodyConstructionInfo_set_m_additionalLinearDampingThresholdSqr_1 = function () {
        return g.asm.Ro.apply(null, arguments);
      }),
    ...
    b = {
      ...
      Is: function () {
        ...
        b.buffer ||
          ((b.size += 128), (b.buffer = g._malloc(b.size)), assert(b.buffer));
        b.Qs = 0;
      },
      Vs: function (a, c) {
        assert(b.buffer);
    ...
    x.prototype.set_m_useConvexConservativeDistanceUtil = x.prototype.Mv = function (
      a,
    ) {
      var c = this.zs;
      a && 'object' === typeof a && (a = a.zs);
    ...
    x.prototype.set_m_convexConservativeDistanceThreshold = x.prototype.Ou = function (
      a,
    ) {
      var c = this.zs;
      a && 'object' === typeof a && (a = a.zs);
    ...
    Object.defineProperty(
      ...
      { get: x.prototype.vt, set: x.prototype.Ou },
    );
    ...
    D.prototype.set_m_additionalLinearDampingThresholdSqr = D.prototype.Gu = function (
      a,
    ) {
      var c = this.zs;
      a && 'object' === typeof a && (a = a.zs);
    ...
    Object.defineProperty(
      ...
      { get: D.prototype.nt, set: D.prototype.Gu },
    );
    D.prototype.get_m_additionalAngularDampingThresholdSqr = D.prototype.kt = function () {
      return Vq(this.zs);
    };
    D.prototype.set_m_additionalAngularDampingThresholdSqr = D.prototype.Du = function (
      a,
    ) {
      var c = this.zs;
      a && 'object' === typeof a && (a = a.zs);
    ...
    D.prototype.set_m_additionalAngularDampingFactor = D.prototype.Cu = function (
      a,
    ) {
      var c = this.zs;
      a && 'object' === typeof a && (a = a.zs);
    ...
    z.prototype.set_m_splitImpulsePenetrationThreshold = z.prototype.Fv = function (
      a,
    ) {
      var c = this.zs;
      a && 'object' === typeof a && (a = a.zs);
